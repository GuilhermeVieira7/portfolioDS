...
const duoTranslations = {
  pt: {
    ...
    "hero.title_html": "<span class=\"block font-medium text-gray-400 text-xl sm:text-2xl md:text-3xl tracking-normal mb-2 sm:mb-3\">Construímos sites que</span><span class=\"block font-extrabold text-white text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] tracking-tighter\"><span class=\"text-gradient-brand\">aceleram vendas<br class=\"hidden sm:inline\" /> e geram valor.</span></span>",
  ...
  en: {
    ...
    "hero.title_html": "<span class=\"block font-medium text-gray-400 text-xl sm:text-2xl md:text-3xl tracking-normal mb-2 sm:mb-3\">We build websites that</span><span class=\"block font-extrabold text-white text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] tracking-tighter\"><span class=\"text-gradient-brand\">accelerate sales<br class=\"hidden sm:inline\" /> and drive growth.</span></span>",
